            ...
            <div className="col">
                <Card className="m-4 text-center" bg="light" border="primary">
                    ...
                    <Card.Body>
                        ...
                        <Button href="/teams/1" variant="primary">About team</Button>
                    </Card.Body>
                </Card>
            </div>
            <div className="col">
                <Card className="m-4 text-center" bg="light">
                    ...
                    <Card.Body>
                        ...
                        <Button href="/teams/2" variant="primary">About team</Button>
                    </Card.Body>
                </Card>
            </div>
            ...
            <div className="col">
                <Card className="m-4 text-center" bg="light">
                    ...
                    <Card.Body>
                        ...
                        <Button href="/teams/3" variant="primary">About team</Button>
                    </Card.Body>
                </Card>
            </div>
        </div>
